...
```{r missing, echo=FALSE, fig.width=10, fig.height=8}
library(visdat)
library(ggplot2)
library(plotly)
library(reshape2)
...
```{r positiveIndicators, echo=FALSE, fig.width=10, fig.height=8}
...
p <- layout(p,
  font = list(family = "'Montserrat', sans-serif"),
  title = "% Change of Correlation of Positive WB Indicators wrt 2014",
  xaxis = list(dtick = 1),
...
```{r negativeCorrelation, echo=FALSE, fig.width=10, fig.height=8}
reqInd = c(
...
p <- layout(p,
  font = list(family = "'Montserrat', sans-serif"),
  title = "% Change of Correlation of Negative WB Indicators wrt 2014",
  xaxis = list(dtick = 1),
  yaxis = list(title = "Percentage Change from 2014"),
  legend = list(x = 0, y = 0, xpd = TRUE),
  plot_bgcolor = 'transparent',
...
```{r otherGraph, echo=FALSE, fig.width=10, fig.height=8}
reqInd = c(
...
p <- layout(p,
  font = list(family = "'Montserrat', sans-serif"),
  title = "% Change of Correlation of Uncorrelated WB Indicators wrt 2014",
  xaxis = list(dtick = 1),
  yaxis = list(title = "Percentage Change from 2014"),
  legend = list(x = 0, y = 0, xpd = TRUE),
  plot_bgcolor = 'transparent',
